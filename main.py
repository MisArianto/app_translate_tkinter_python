...
class Translation(object):
    ...
    def translate_page(self):
        self.top_label = Label(self.translate_tab, text="Enter Sentence:")
        ...
        self.translate_button = Button(
            self.translate_tab, text="Translate!", command=self.translation)
        ...
        self.word_frame = LabelFrame(
            self.translate_tab, text="Translation:", width=300, height=50)
